...
<form  action="valideconnexion.aspx" method="post">
        <sw:if test="${!empty sessionScope.errone }">
            <div class="row">
            <div class="col">
                <div class="alert alert-danger alert-dismissable fade show" role="alert">
                    ...
                    <h6 class="alert-heading">Connexion erroné</h6>
                </div>
            </div>
        </div>
            ...
            <div class="form-group"><button class="btn btn-primary btn-block" type="submit" style="color: rgb(255,255,255);background-color: rgb(157,157,157);">Connexion</button></div>
            <a class="forgot" href="inscription.aspx">Créer votre compte Pixel</a>
            </form>
    </div>
