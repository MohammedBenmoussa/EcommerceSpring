...
<head>
    ...
    <link rel="stylesheet" href="css/styles.min.css?h=ab2d1eb0d8e707ab1d9c2a8d94851c0a">
	<style type="text/css">
...
<div class="login-clean" style="background-color: rgb(242,242,242);">
<form  action="valideinscription.aspx" method="post">
     
            <h2 class="sr-only">Login Form</h2>
            <div class="illustration"><img src="img/pixel.png" style="margin: auto;"></div>
            <div class="form-group"><input class="form-control" type="text" name="nom_client" placeholder="Nom"></div>
            <div class="form-group"><input class="form-control" type="email" name="email_client" placeholder="Email"></div>
            <div class="form-group"><input class="form-control" type="password" name="password" placeholder="Password"></div>
            <div class="form-group"><input class="form-control" type="text" name="adresse_client" placeholder="Adresse"></div>
            <div class="form-group"><button class="btn btn-primary btn-block" type="submit" style="color: rgb(255,255,255);background-color: rgb(157,157,157);">S'incrire</button></div>
            <a class="forgot" href="connexion.aspx">Se connecter</a>
            </form>
    </div>
