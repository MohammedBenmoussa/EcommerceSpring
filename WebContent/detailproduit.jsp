...
<img  class="logo" src="https://fontmeme.com/permalink/190712/eb30e27ba1819e5e7730309214656ec4.png" alt="pixel-fonts" border="0">
		<nav>
			<ul class="nav_links">
				...
				</sw:if>				<sw:if test="${!empty sessionScope.admin }">
...
<form action="ajouterdetailproduit.aspx" method="post" >
	<table class="tableau">
		<caption>Ajouter detail de produit</caption>
<tr>
<td><label class="lab">designation:</label></td>
<td><input class="inp" type="text" name="designation"></td>
</tr>
<tr>
<td><label class="lab">prix:</label></td>
<td><input class="inp" type="text" name="prix"></td>
</tr>
<tr>
<td><label class="lab">quantite produit:</label></td>
<td><input class="inp"type="text" name="quantite_produit"></td>
</tr>
<tr>
<td><label class="lab">image:</label></td>
<td><input class="inp" type="text" name="image"></td>
</tr>
<tr>
<td><label class="lab">description:</label></td>
<td><textarea class="inp"  name="description"></textarea></td>
</tr>
<tr>
<td colspan="2"><center><input type="submit" value="envoyer"></center></td>
</tr>
