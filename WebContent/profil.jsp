...
<img  class="logo" src="https://fontmeme.com/permalink/190712/eb30e27ba1819e5e7730309214656ec4.png" alt="pixel-fonts" border="0">
		<nav>
			<ul class="nav_links">
				...
				<sw:if test="${empty sessionScope.user }">
      ...
      <li class="sub-menu"><a   href="client.aspx">Client</a></li>
       <li class="sub-menu"><a   href="listeordre.aspx">Ordre</a></li>
    	</ul>
				</li>
				</sw:if>
   	...
   	<sw:forEach items="${listeProd}" var="u" >
   		<div>
   			<div class="card product-card">
   				<img class="card-img-top img-fluid" src="${u.getImage() }">
   				<div class="card-body">
...
<div class="container">
        ...
        <div class="row product-list dev">
            ...
            <div class="col-sm-6 col-md-3 product-item animation-element slide-top-left">
                <div class="product-container">
                    <div class="row">
                        <div class="col-md-12"><a class="product-image" href="#"><img class="card-img-top img-fluid" src="${u.getImage() }"></a></div>
                    </div>
                    <div class="row">
                        <div class="col-8">
                            <h2><a href="lolo.aspx?id=${u.getId_detail_produit() }">${u.getDesignation() }</a></h2>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <p class="product-description">${u.getDescription() }</p>
                            <div class="row">
                            <div class="col-6">
                            <sw:if test="${empty sessionScope.email}">
					      <a href="connexion.aspx" class="btn btn-info">Ajouter au panier</a> &nbsp;
                                 ...
                                 <sw:if test="${!empty sessionScope.email}">
					      <a href="panier.aspx?id=${u.id_detail_produit}" class="btn btn-info" style="padding:0;">Ajouter au panier</a>
					      </sw:if>
					      </div>
                                <div class="col-6">
                                    <p class="product-price" style="padding:0;">${u.getPrix()}Dhs</p>
                                </div>
                            </div>
                        </div>
                    </div>
