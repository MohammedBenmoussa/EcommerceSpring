...
<form action="ajouterCategorie.aspx" method="post">
 <table class="tableau">
 <caption><h2>Ajouter une catégorie</h2></caption>
	<tr>
<td><label class="lab">Nom:</label></td>
<td><input class="inp" type="text" name="nom_cat"><br/></td>
	</tr>
	<tr>
<td><label class="lab">Description:</label></td>
<td><textarea class="inp" rows="5" cols="16" name="description_cat"></textarea></td>
	</tr>
<br/>
<tr>
<td><label class="lab">Image:</label></td>
<td><input class="inp" type="file" name="image_cat"></td>
</tr>
<br/>
<tr>
<td></td>
...
<tbody>
		...
		<!--  categorie  -->
		<sw:forEach items="${listCategorie}" var="u" >
			<tr>
			
				<td>${u.id_cat }</td>
				<td>${u.nom_cat }</td>
				<td>${u.description_cat}</td>		
				<td><img src=${u.image_cat }></td>			
				<td><a class="tdinf" href="supprimerCategorie.aspx?id=${u.id_cat }">supprimer</a></td>
				<td><a class="tdinf" href="modifierCategorie.aspx?id=${u.id_cat }">Modifier</a></td>
