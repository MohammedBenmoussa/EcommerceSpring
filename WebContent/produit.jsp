...
<img  class="logo" src="https://fontmeme.com/permalink/190712/eb30e27ba1819e5e7730309214656ec4.png" alt="pixel-fonts" border="0">
 ...
 <a href="#" class="ct"><button>Contactez-nous</button></a>
	...
	<form action="ajouterProduit.aspx" method="post">
<table class="tableau">
 <caption><h2>Ajouter produit</h2></caption> 
 <tr>
<td><label class="lab">Categorie:</label></td>
<td><select class="inp" name="id_prod_cat">
	<sw:forEach items="${listCat}" var="u" >
		<option value=${u.id_cat } >${u.id_cat } - ${u.nom_cat }</option>
	</sw:forEach>
</select></td>
</tr>
<tr>
<td><label class="lab">Status:</label></td>
<td><input class="inp" type="text" name="prod_status"></td></tr>
<br/>
<tr>
<td></td>
...
<table  width="70%" border="1" cellpadding="0" cellspacing="0" class="design">
<thead> 
	<caption>Liste des produits </caption>
<tr>
	<th>id_detail_produit </th>
	<th>id_prod </th>
	<th>designation </th>
	<th>prix</th>
...
<tbody>
		...
		<!--  listeProduit  -->
		<sw:forEach items="${lstprd}" var="b" >
			<tr>
			
				<td>${b.id_detail_produit }</td>
				<td>${b.id_prod }</td>
				<td>${b.designation}</td>	
				<td>${b.prix}</td>
				<td>${b.quantite_produit}</td>
				<td><img style="width: 100px; height: 100px;" src="${b.image}"/></td>	
				<td>${b.description}</td>
						
				<td><a class="tdinf" href="supprimerProduit.aspx?id=${b.id_detail_produit }">supprimer</a></td>
				<td><a class="tdinf" href="modifierProduit.aspx?id=${b.id_detail_produit }">Modifier</a></td>
