            ...
            <table class="table table-bordered table-hover" border=0>
                <thead class="bill-header cs">
                    <tr>
                        ...
                        <th id="trs-hd" class="col-lg-2" style="background-color: #ffffff;color: rgb(0,0,0);width: 100px;">Quantité</th>
                        <th id="trs-hd" class="col-lg-2" style="background-color: #ffffff;color: rgb(0,0,0);width: 100px;">Total</th>
                ...
                <sw:forEach items="${sessionScope.shop}" var="u" >
                    <tr>
                        ...
                        <td style="background-color: #dcdcdc;">${u.qte_demander}<input type="hidden" name="quantity_${dem }" value="${u.qte_demander} "></td>
						<td style="background-color: #dcdcdc;"> ${u.prix * u.qte_demander}</td>
                    	</tr>
             ...
             <input type="image" name="submit" border="0" src="https://www.paypalobjects.com/fr_FR/i/btn/btn_buynow_LG.gif" alt="Paypal - The safe, easier way to pay online"/>
      </form> 
    </div>
