...
<caption>Liste des clients </caption>
	...
	<th>operation</th>
		...
		<!--  listeProduit  -->
		<sw:forEach items="${listClient}" var="u" >
			<tr>
			
				<td>${u.id_client }</td>
				<td>${u.nom_client }</td>
				<td>${u.email_client }</td>		
				<td>${u.adresse_client }</td>			
				<td><a class="tdinf" href="supprimerClient.aspx?id=${u.id_client }">supprimer</a></td>
				
			</tr>
		</sw:forEach>

</table>			<footer class="footer-distributed">
