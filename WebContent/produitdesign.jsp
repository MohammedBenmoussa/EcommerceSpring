...
<div class="container">
        <h1 class="text-center">Detail Produit</h1>
        <br/>
        <br/>
        <div class="row">
            <div class="col-md-7">
                <div class="row">
                    <div class="col-md-12"><img class="img-thumbnail img-fluid center-block" src=" ${detailProduit.getImage()}"></div>
                </div>
                
            </div>
            <div class="col-md-5">
                <h1>${detailProduit.getDesignation()}</h1>
                <p>${detailProduit.getDescription()} </p>
                <h2 class="text-center text-success"><i class="fa fa-cc-paypal"></i>  ${detailProduit.getPrix()} DHS</h2><br><br>
                <a href="panier.aspx?id=${detailProduit.getId_detail_produit()}" class="btn btn-danger btn-lg center-block"  type="button"><i class="fa fa-cart-plus"></i> Ajouter au panier	</a>
                <div class="row" style="margin-top: 15px;background-color: #ffffff;">
                  
                </div>
            </div>
        </div>
        <div class="row" id="bottom" style="margin-right: 0;margin-left: 0;background-color: #ecfcff;width: 944px;">
